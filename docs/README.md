...
| you need the latest packaged-app visual checks | [research/computer-use-2026-09-12-inline-zip.md](research/computer-use-2026-09-12-inline-zip.md) — current iteration, observations and final verification; [earlier record](research/computer-use-2026-09-12.md) includes the previous standalone ZIP window | 中文 |

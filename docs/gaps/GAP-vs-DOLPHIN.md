...
| Sort options: descending / folders first / **hidden files last** | Ascending and descending ✅, folders first permanently on | No "hidden last", and "folders first" cannot be turned off |
